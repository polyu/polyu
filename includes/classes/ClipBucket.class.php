...
class ClipBucket 
{
	...
	function LatestAdminMenu()
	{
			...
			if($per['group_moderation'] == "yes" && false) //hack here
			...
			if($per['ad_manager_access'] == "yes" && false)
				$NewMenu['Advertisement'] = 			   array(
				  'Manage Advertisments'=>'ads_manager.php',
				  'Manage Placements'=>'ads_add_placements.php'
				);
			if($per['manage_template_access'] == "yes" && false)
			...
			if($per['plugins_moderation'] == "yes" && false)
