<?php /* Smarty version 2.6.18, created on 2012-09-11 14:16:02
         compiled from /home/wwwroot/admin_area/styles/cbv2/layout/category.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'post_form_val', '/home/wwwroot/admin_area/styles/cbv2/layout/category.html', 24, false),array('function', 'cbCategories', '/home/wwwroot/admin_area/styles/cbv2/layout/category.html', 36, false),)), $this); ?>
...
" size="45" />
    ...
    <?php $this->assign('useSubs', config(use_subs)); ?>
    <?php if ($this->_tpl_vars['useSubs'] == 1): ?>
    <tr>
      <td valign="top" class="td_body">Parent Category</td>
      <td class="td_body">
		<?php echo getSmartyCategoryList(array('output' => 'dropdown','name' => 'parent_cat','id' => 'parent_cat','blank_option' => 'TRUE','echo' => 'TRUE','type' => 'video'), $this);?>
...
" size="45" />
    ...
    <tr>
      <td valign="top" class="td_body">Parent Category</td>
      <td class="td_body">
        <?php echo getSmartyCategoryList(array('output' => 'dropdown','selected' => $this->_tpl_vars['cat_details']['parent_id'],'name' => 'parent_cat','id' => 'parent_cat','blank_option' => 'TRUE','type' => 'video','echo' => 'TRUE'), $this);?>
...
"  title="<img src='<?php echo $this->_tpl_vars['cbvid']->get_category_thumb($this->_tpl_vars['category'][$this->_sections['list']['index']]); ?>
...
" size="5" maxlength="5" /></td>
	<?php if ($this->_tpl_vars['category'][$this->_sections['list']['index']]['parent_id'] == '0'): ?>
		<?php $this->assign('p_name', 'None'); ?>
	<?php else: ?>
		<?php $this->assign('p_name', $this->_tpl_vars['cbvid']->get_category_field($this->_tpl_vars['category'][$this->_sections['list']['index']]['parent_id'],'category_name')); ?>
	<?php endif; ?>
	<td><?php echo $this->_tpl_vars['p_name']; ?>
</td>
