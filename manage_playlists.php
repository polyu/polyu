...
switch($mode)
{
	...
	default:
	{
		...
		{
			$params = array('name'=>mysql_clean($_POST['name']),'describe'=>mysql_clean($_POST['describe']));
	...
	case 'edit_playlist':
	{
		...
		{
			$params = array('name'=>mysql_clean($_POST['name']),'describe'=>mysql_clean($_POST['describe']),'pid'=>mysql_clean($pid));
